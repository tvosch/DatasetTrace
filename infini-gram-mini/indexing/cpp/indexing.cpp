// g++ -std=c++17 -I../sdsl/include -L../sdsl/lib indexing.cpp -o cpp/cpp_indexing -lsdsl -ldivsufsort -ldivsufsort64
// GCILK=true g++ -std=c++11 -I../parallel_sdsl/include -L../parallel_sdsl/lib indexing.cpp -o cpp/cpp_indexing -lsdsl -ldivsufsort -ldivsufsort64 -DCILKP -fcilkplus -O2
